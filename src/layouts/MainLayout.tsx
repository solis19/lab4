        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 relative z-10">
          <div className="flex justify-start items-center h-14 sm:h-20 gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-4 ml-auto">
              <Link
                to="/profile"
                className="text-[10px] sm:text-sm text-white hover:text-blue-100 transition-colors truncate max-w-[60px] sm:max-w-none flex items-center gap-0.5 sm:gap-1 group"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 opacity-80 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
